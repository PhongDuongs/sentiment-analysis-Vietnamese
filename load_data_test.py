...
folder_path = '/sentiment/data_train/data_train/test/pos'
...
folder_path_neg = '/sentiment/data_train/data_train/test/neg'
...
output_csv_file_path = 'data_test_modified.csv'
